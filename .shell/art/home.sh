...
echo -e "${BYELLOW}██${BRED}╗    ${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}╗ ${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}╗${BYELLOW}████████${BRED}╗${BYELLOW}███████${BRED}╗${BYELLOW}██████${BRED}╗  ${BYELLOW}████${BRED}╗ ${BYELLOW}██████${BRED}╗ ${BYELLOW}██████${BRED}╗ ${BYELLOW}██${BRED}╗${BYELLOW}████████${BRED}╗"
echo -e "${BYELLOW}██${BRED}║    ${BYELLOW}██${BRED}║${BYELLOW}██${BRED}║ ${BYELLOW}██${BRED}║${BYELLOW}██${BRED}║╚══${BYELLOW}██${BRED}╔══╝${BYELLOW}██${BRED}╔════╝${BYELLOW}██${BRED}╔══${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}╔═${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}╔══${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}╔══${BYELLOW}██${BRED}╗${BYELLOW}██${BRED}║╚══${BYELLOW}██${BRED}╔══╝"
echo -e "${BYELLOW}██${BRED}║ ${BYELLOW}█${BRED}╗ ${BYELLOW}██${BRED}║${BYELLOW}██████${BRED}║${BYELLOW}██${BRED}║   ${BYELLOW}██${BRED}║   ${BYELLOW}█████${BRED}╗  ${BYELLOW}██████${BRED}╔╝${BYELLOW}██████${BRED}║${BYELLOW}██████${BRED}╔╝${BYELLOW}██████${BRED}╔╝${BYELLOW}██${BRED}║   ${BYELLOW}██${BRED}║   "
